...
@Configuration
@ConditionalOnExpression("'${elaticjob.zookeeper.auto.config}' == true")
    ...
    public void initElasticJob() {
        ...
        for (Map.Entry<String, SimpleJob> entry : map.entrySet()) {
            ...
            SimpleJobConfiguration simpleJobConfiguration = new SimpleJobConfiguration(
                    JobCoreConfiguration.newBuilder(elasticSimpleJobAnnotation.jobName(), cron, elasticSimpleJobAnnotation.shardingTotalCount()).shardingItemParameters(elasticSimpleJobAnnotation.shardingItemParameters()).build(),
